...
const manifest = {
  ...
  "presets": [
    ...
    ,
    {
      "name": "科技黑",
      "id": "tech-black",
      "description": "A sleek, tech-style dark theme",
      "values": {
        "motion-color": "#2461B7",
        "looks-color": "#633EAC",
        "sounds-color": "#863286",
    ...
    },
    {
      "name": "雪花白",
      "id": "snow-white",
      "description": "A clean, snow-white light theme",
      "values": {
        "motion-color": "#4C97FF",
        "looks-color": "#9966FF",
        "sounds-color": "#CF63CF",
    ...
    },
    {
      "name": "橙色",
      "id": "orange",
      "description": "A high-contrast orange-first theme",
      "values": {
        "motion-color": "#FF9B33",
        "looks-color": "#FF8C1A",
        "sounds-color": "#FF7A00",
        "events-color": "#FF9B33",
        "control-color": "#FFAA33",
        "sensing-color": "#FF9933",
        "operators-color": "#FF9933",
        "data-color": "#FF9B33",
        "data-lists-color": "#FF8C1A",
        "custom-color": "#FF6F6F",
        "Pen-color": "#FFFFFF",
        "sa-color": "#FFFFFF",
        "comment-color": "#FFF2E6",
        "input-color": "#FFFFFF",
        "text": "white"
      }
    }
