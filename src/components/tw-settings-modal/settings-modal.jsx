...
const SettingsModalComponent = props => (
    ...
    >
        <Box className={styles.body}>
            ...
            />
            {props.highFpsWarning && (
                <div className={styles.warning}>
                    <FormattedMessage
                        defaultMessage="如果将FPS设置到250以上作品可能会不正常"
                        description="Warning when FPS is set above 250"
                        id="tw.settingsModal.highFpsWarning"
                    />
                </div>
            )}
            <Interpolation
